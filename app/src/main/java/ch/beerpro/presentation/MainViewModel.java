...
public class MainViewModel extends ViewModel implements CurrentUser {
    ...
    private final LiveData<List<FridgeContent>> myFridge;
    ...
    public MainViewModel() {
        ...
        myFridge = fridgeRepository.getAllFridgeContentInstancesForUser(currentUserId);
   ...
   public LiveData<List<FridgeContent>> getMyFridge() { return myFridge; };
